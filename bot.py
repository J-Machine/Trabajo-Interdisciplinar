...
def start(update, context):
    ...
    logger.info(f'El usuario {user_Name} ha iniciado(/start) el bot')
    update.message.reply_text(f'Hola {user_Name}, gracias por usar nuestro bot.\n'
                              f'A continuación te mostramos los comandos que puedes usar:')
